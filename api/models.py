...
from mongoengine import  ReferenceField, BooleanField, EmbeddedDocumentListField, EmbeddedDocument
...
class Bounty(Document):
    ...
    bounty_assigned = ReferenceField(Freelancer) #might be none as well if not yet assigned
